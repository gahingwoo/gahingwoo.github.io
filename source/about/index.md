...
- **NPU, both stacks.** On the vendor runtime (RKNPU/RKLLM) I got real LLMs and vision
  ...
  reverse-engineered the undocumented compute registers until MobileNet V1 classified
  end to end on the NPU. Version 1 of my preprint blamed the hardware for chained layers
  stalling and was wrong; it was a 16-bit field written as 12, and version 2 withdraws it
  and is mostly about how that error survived thirty-eight days. Written up as
  [a preprint](https://doi.org/10.5281/zenodo.21348016).
...
[Preprint (DOI)](https://doi.org/10.5281/zenodo.21348016) ·
